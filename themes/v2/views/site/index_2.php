...
<div id="main-content" class="container-fluid">
    <div class="row">
        <div id="page-slider">
                ...
                <div class="container">
                    <div class="row content">
                        ...
                        <div class="col-sm-8 col-r">
                            <div class="caption">
                                <img class="img-responsive" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/home/page-01-text.gif" alt="您还在因预约不到名医而无助吗？您还在为入住三甲医院而焦虑吗？"/>
                                <div class="hide line-1">您还在因预约不到名医而无助吗？</div>
                                <div class="hide line-2">您还在为入住三甲医院而焦虑吗？</div>
                            </div>
                            <div class="btn-group">
                                <a type="button" class="btn my-btn-blue btn-lg btn-app-dl" href="javascript:void(0);"><i class="fa fa-download">&nbsp;</i>下载App</a>
            ...
            <div class="slide page-intro2">
                <div class="container">
                    <div class="row content">                       
                        <div class="col-sm-8 col-l">
                            <div class="caption">
                                <img class="img-responsive" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/home/page-02-text.gif" alt="登录名医会诊网？三甲名医主刀&nbsp;床位随时入住？"/>
                                <div class="hide line-1">登录名医会诊网</div>
                                <div class="hide line-2"><span class="color-green strong" style="text-shadow:none;">我们承诺</span>&nbsp;&nbsp;三甲名医主刀&nbsp;&nbsp;床位随时入住</div>
                            </div>
                            <div class="btn-group">
                                <a type="button" class="btn my-btn-blue btn-lg btn-app-dl" href="javascript:void(0);"><i class="fa fa-download">&nbsp;</i>下载App</a>
                                <a  type="button" class="btn btn-success btn-lg" href="<?php echo $this->createUrl('medicalrecord/create');?>"><i class="fa fa-headphones"></i>&nbsp;在线预约</a>
                        ...
                        <div class="col-sm-4 col-r hidden-xs">
                            <div class="row pic block"></div>
                        </div>
                    </div>    
                </div>
                    ...
                    <div class="row content">
                        ...
                        <div class="col-sm-6 col-r">
                            <div class="row">
                                ...
                                <div class="btn-group">
                                    <a id="btn-app-dl" type="button" class="btn my-btn-blue btn-lg" href="#app-dl"><i class="fa fa-download">&nbsp;</i>下载App</a>
