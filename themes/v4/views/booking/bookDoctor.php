...
// hospital_id
// hp_dept_id
//$form->hiddenField($model, 'doctor_id', array('name'=>'booking[doctor_id]'));
?>
<div id="<?php echo $this->getPageID(); ?>" data-role="page" data-title="<?php echo $this->getPageTitle(); ?>" data-nav-rel="#f-nav-doctor" data-add-back-btn="true" data-back-btn-text="返回">
    <div data-role="content">
        <div class="form-wrapper">
            ...
            //    echo $form->hiddenField($model, 'hospital_id', array('name' => 'booking[hospital_id]'));
