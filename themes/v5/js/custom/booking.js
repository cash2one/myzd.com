...
//                break;
    ...
    uploader.onError = function (code) {
        ...
        $("#tipModal .modal-body").text(errorinfo);
        $('#tipModal').modal();
            ...
            domForm.ajaxSubmit({
                ...
                success: function (data) {
                    ...
                    if (data.status == 'ok') {
                        ...
                        //弹框提示
                        $("#bookingModal .modal-dialog").addClass('modal-sm');
                        $("#bookingModal .successTip").html("<h4>预约成功!</h4><p>我们的工作人员会尽快联系您!</p>");
                        $("#bookingModal .booking-form").hide();
                        $("#bookingModal .modal-footer").show();
                        $("#bookingModal").modal();
                        confirmbtnTimerStart($("#bookingModal .modal-footer .btn"), 5000);
                        //专家团队弹框
