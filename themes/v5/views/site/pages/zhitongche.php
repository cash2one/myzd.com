...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="container">
            <div class="mt30 row">
                <div class="col-sm-8" >
                    <div class="ztc-bg-green color-white h320p"> 
                        <div class="row color-white ztc-title-text">
                            <div class="col-sm-2"></div>
                            <div class="col-sm-4 ml-20">“手术直通车”是名医主刀平台联合各大临床医疗专家，协助患者快捷手术的服务。名医主刀医疗助手将为患者整理资料、联系医生确认病情。</div>
                            <div class="col-sm-4 ml20">符合手术直通车要求的患者，医院医生助理将为患者预约好入院日期、排队留床，患者在约好的日期来医院、直接入院。避免反复奔波、长时间院外待床，减少不必要的花费。</div>
                        </div>
                    </div>
                </div>
