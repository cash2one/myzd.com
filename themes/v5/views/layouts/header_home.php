...
<div class="container-fluid pt50 collapse bg-home-top" id="header_home">
    <div class="row">
        <div class="container">	
            <div class="row">
                <div class="col-sm-3">
                    <div class="h180"><img src="<?php echo $urlResImage; ?>icons/icon_doctor.png"></div>
                ...
                <div class="col-sm-3">
                    <div class="h180"><img src="<?php echo $urlResImage; ?>icons/icon_seat.png"></div>
                ...
                <div class="col-sm-3">
                    <div class="h180"><img src="<?php echo $urlResImage; ?>icons/icon_car.png"></div>
