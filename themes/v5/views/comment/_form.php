...
Yii::app()->clientScript->registerScriptFile("http://static.mingyizhudao.com/comment.min.js", CClientScript::POS_HEAD);
...
echo CHtml::hiddenField("CommentForm[disease_detail]", $booking->diseaseName);
echo CHtml::hiddenField("CommentForm[effect]", 5);
echo CHtml::hiddenField("CommentForm[doctor_attitude]", 5);
?>
