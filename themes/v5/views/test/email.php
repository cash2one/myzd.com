...
$bookingUrl = $this->createAbsoluteUrl('booking/view', array('refNo' => 'asdf'));
$faqUrl ='';
$rulesUrl='';
?>
    ...
    <table cellpadding="10" style="width:100%;height:100%;background-color: #FAF8F8;border-collapse:collapse;font-family: 'Microsoft YaHei';">
        ...
        <tbody>
            <tr xstyle="height:40px;text-indent:20px;color:#000">
                <td colspan="2"><strong>亲爱的小明，</strong></td>
            </tr>
            ...
            <tr>
                <td style="width:20%;text-align: right;">订单号：</td><td><?php //echo $booking->getReferenceNumber();  ?></td>
            </tr>
            <tr>
