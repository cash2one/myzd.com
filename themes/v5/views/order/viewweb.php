            ...
            <div class="pb40 border-green mt10">         
                <div class="pl20 pr20">
                    ...
                    <div>
                        ...
                        <div class="mt50">
                            <a href="<?php echo $this->createUrl('user/paySuccess',array('id'=>$bookingId)) ?>" class="btn btn-yes">立即支付</a>
                            <a href="<?php echo $this->createUrl('booking/view') ?>" class="ml20 link-gray">暂不支付</a>
                        </div>
                    </div>
                    <div class="divider mt40"></div>
                    <div class="color-statement lineheight2-5em mt10">声明:<br/>1. 请您付款务必阅读《<a class="color-green" href="<?php echo $urlTerms; ?>" target="_blank">名医主刀在线服务协议</a>》<br/>
                        2. 名医主刀会为您的隐私全程保密。<br/>
