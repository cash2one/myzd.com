...
<section id="cancer">
    <div class="container">      
        ...
        <div class="text-center text15 color-gray7">
            ...
            <div class="mt10">是不是身上经常莫名其妙的出现一些小肿块，当时满不在意。</div>
            <div class="mt10">有时，正是这些小肿块，恶化成了癌症。</div>
            <div class="mt10">今天，名医君就给大家介绍出现在身上的小肿块可能存在哪些隐患，以及常见的一些误区。</div>
        </div>
    </div>
    <div class="container mt50" >
        <div class="bg-daede5 content-one">
            <div class="text-center content-title">身体肿块别小瞧</div>
            <div class="row mt50">
                <div class="col-sm-4">
                    <div class="cancer-area">
                        <div class="yellow-title">1、口腔里的"肿块"</div>
                        <div>如果口腔出现白斑，用任何方法也无法消除，特别是白斑的中央出现了红色，或是红斑的中央变白，可能就是口腔癌的病兆。</div></div>
                    <div class="cancer-area"><div class="yellow-title">4、肛门肿块</div>
                        <div>痔疮最多见，但有时可能由肠癌引起。如果伴有便秘、腹泻、不明原因的体重减轻、昏睡、阵发性眩晕和肠道排空感异常等症状，一定要去看肛肠科医生。</div></div>
                    <div class="cancer-area"><div class="yellow-title">7、手臂下的肿块</div>
                        <div>肿块质地柔软，有弹性，一碰就疼，饮酒后痛感更强，这可能是乳腺癌或霍奇金氏淋巴瘤的病兆。</div></div>
                </div>
                <div class="col-sm-4">
                    <div class="cancer-area"><div class="yellow-title">2、乳房肿块</div>
                        <div>90%乳房肿块为良性，但要注意，如果乳房的形状、大小、手感发生变化，乳头或乳房周围的皮肤出现了皱褶、凹陷、颜色变红、溢乳，或是单侧乳房感到疼痛或不适，要及时就医。</div></div>
                    <div class="cancer-area"><div class="yellow-title">5、肩部肿块</div>
                        <div>多为脂肪瘤，它质地柔软表面光滑，属于良性肿块。不过，如果脂肪瘤压迫神经造成疼痛，需要手术切除。</div></div>
                    <div class="cancer-area"><div class="yellow-title">8、腿上的肿块</div>
                        <div>如果腿上的肿块伴有流血、疼痛、发痒或是长时间不愈合，很可能是皮肤癌(鳞状细胞癌)的病兆。</div></div>
                </div>
                <div class="col-sm-4">
                    <div class="cancer-area"><div class="yellow-title">3、脖子上的肿块</div>
                        <div>多由皮脂腺囊肿引起，通常不会致癌。但也可能是白血病或霍奇金氏淋巴瘤的先兆，特点是常位于脖子的一侧，质地坚硬。喉结附近的肿块如果持续增大，三周还不消退，应及时去甲状腺专科门诊就医。</div></div>
                    <div class="cancer-area"><div class="yellow-title">6、手腕上的肿块</div>
                        <div>最常见的是腱鞘囊肿，可以找外科医生用注射器抽走其中的液体，一般很快就能恢复。如果肿块没有痛感，却越来越大，有可能是肉瘤，不过这种病较为罕见。</div></div>
                    <div class="cancer-area"><div class="yellow-title">9、腹股沟的肿块</div>
                        <div>霍奇金氏淋巴瘤可导致腹股沟的皮肤下出现无痛肿块，症状还包括夜间盗汗、发烧、疲劳、不明原因的体重减轻、皮肤发痒和出疹子。</div></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="content-three">
            <div class="text-center">
                <div class="content-title mb30">防癌常见误区</div>
                <div class="text15">
                    <div>随着人们的健康意识的提高，对于防癌体检也能够主动的去医院进行检查。</div>
                    <div>但是，还是有很多人认为花的钱越多，检查的项目越多，效果就越好。</div>
                    <div>那么真相到底是什么呢？</div>
            ...
            <div class="row">                 
                <div class="col-sm-7"> 
                    <div class="mt30">这种想法是不正确的。</div>
                    <div>PET-CT既包括结构检查也包括功能检查，较一般的超声、CT检查具有明显的优势。</div>
                    <div>但是，PET-CT也不是万能的。</div>
                    <div>在癌症筛查方面，PET-CT检查在早期胃癌、肠癌、宫颈癌方面不如胃镜、肠镜和宫颈细胞学TCT敏感，不能代替上述三种检查方法。</div>
            ...
            <div class="row mt30">
                ...
                <div class="col-sm-7 text-right">  
                    ...
                    <div>部分肿瘤患者在诊断时出现血肿瘤标志物升高，</div>
                    <div>但是还有一部分患者即使到了肿瘤的晚期肿瘤标志物也不升高，</div>
                    <div>因此，不能只查血的肿瘤标志物诊断癌症。</div>
            ...
            <div class="row mt30">               
                <div class="col-sm-7">
                    <div class="mt10">目前，越来越多的体检中心把血液检查包括在体检项目中，于是发现了许多肿瘤标志物升高的人员。</div>
                    <div>经常引起体检人员和家属的恐慌。</div>
                    <div>事实上，外周血肿瘤标志物的轻度升高大多数人经过全面的临床检查不是肿瘤患者。</div>
    ...
    <div class="container">
        <div class="content-four">
            <div class="text-center content-title">名医主刀签约医生推荐</div>        
            <div class="row">
                <div class="col-md-3 col-sm-6 mt40">
                    <a href="<?php echo $this->createUrl('doctor/view', array('id' => '3054')); ?>">
                        ...
                        <div class="reason">
                            <div class="pull-left title">推<br/>荐<br/>理<br/>由<br/></div>
                            <div class="pull-left middle"></div>
                            <div class="content">科室排名全国前三<br/>
                                全国头颈肿瘤专业委员会常委<br/>
                                科室主任</div>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 mt40">
                    <a href="<?php echo $this->createUrl('doctor/view', array('id' => '82')); ?>">
                        ...
                        <div class="reason">
                            <div class="pull-left title">推<br/>荐<br/>理<br/>由<br/></div>
                            <div class="pull-left middle"></div>
                            <div class="content">科室排名全国第一<br/>
                                美国甲状腺协会会员<br/>
                                每年开展甲状腺疾病手术约500例</div>
                            <div class="clearfix"></div>
                        </div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-6 mt40">
                    <a href="<?php echo $this->createUrl('doctor/view', array('id' => '369')); ?>">
                        ...
                        <div class="reason">
                            <div class="pull-left title">推<br/>荐<br/>理<br/>由<br/></div>
                            <div class="pull-left middle"></div>
                            <div class="content">主刀胃癌、大肠癌手术近一万例<br/>
                                科室主任<br/>
                                大肠癌多综合治疗组首席专家</div>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="col-md-3 col-sm-6 mt40">
                    <a href="<?php echo $this->createUrl('doctor/view', array('id' => '295')); ?>">
                        ...
                        <div class="reason">
                            <div class="pull-left title">推<br/>荐<br/>理<br/>由<br/></div>
                            <div class="pull-left middle"></div>
                            <div class="content">中国知名的乳腺肿瘤专家<br/>
                                科室水平全国领先<br/>
                                “上海市十佳医生”荣誉称号</div>
                            <div class="clearfix"></div>
                        </div>
