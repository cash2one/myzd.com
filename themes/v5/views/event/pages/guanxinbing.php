...
Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . "/css/event-guanxinbing.css");
$urlBooking = $this->createUrl('booking/create', array('ajax' => 1));
?>
<section id="body">
    <div class="container-fluid">
        <div class="row guan-header text-center">
            <img src="<?php echo $urlResImage; ?>/event/guanxinbing/bg-guanxinbing.png">
        </div>
    </div>	
    ...
    <div class="container container-body"> 
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                ...
                <div><div class="mt20"><img src="<?php echo $urlResImage; ?>/event/guanxinbing/bg-heart.png"><span class="title-xs" >1、慧眼识别冠心病症状</span></div>
                ...
                <div><div class="mt20"><img src="<?php echo $urlResImage; ?>/event/guanxinbing/bg-heart.png"><span class="title-xs">2、警惕急性冠脉综合症</span></div>
                ...
                <div><div class="mt20"><img src="<?php echo $urlResImage; ?>/event/guanxinbing/bg-heart.png"><span class="title-xs">3、生活保健不能少</span></div>
                ...
                <div><div class="mt20"><img src="<?php echo $urlResImage; ?>/event/guanxinbing/bg-heart.png"><span class="title-xs">4、不放过蛛丝马迹</span></div>
