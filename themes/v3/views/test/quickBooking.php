...
<table cellpadding="8" border="1">
    <tbody>
        ...
        <tr><td>创建日期：</td><td><?php echo $model->createDate; ?></td></tr>
        <tr><td>预约分类：</td><td><?php echo $model->bookType; ?></td></tr>
        <?php
        switch ($model->bookTypeCode) {
            case '1':
                ?>
        ...
        ?>
        <tr><td>称呼：</td><td><b><?php echo $model->cName; ?></b></td></tr>    
        <tr><td>手机：</td><td><b><?php echo $model->mobile; ?></b></td></tr>
        <tr><td>病情：</td><td><b><?php echo $model->patientCondition; ?></b></td></tr>
    </tbody>
</table>
<h3>上传文件：</h3>
<?php
