...
$form = $this->beginWidget('CActiveForm', array(
    'id' => 'booking-form',
    'action' => $this->createAbsoluteUrl("api/create", array('model' => 'booking')),
...
//$model->booking_type=4;
echo $form->hiddenField($model, "booking_type");
?>
...
<div class="form-group mt30">
    <div class="col-sm-6 col-sm-offset-3">
        <button id="btn-submit" type="submit" class="btn btn-lg btn-yes btn-block" name="">提&nbsp;交</button>       
    </div>
    <div class="clearfix"></div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#btn-submit").click(function (e) {
            ...
            var actionUrl = $("#booking-form").attr("action");
            $.ajax({
                type: 'post',
                url: actionUrl,
                data: formData,
