...
<html lang="zh" xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge,Chrome=1x"/>
        <meta charset="utf-8" />
        ...
        Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . "/css/faculty.css");
    ...
    <body>
        ...
        <section id="site-content">
            <div class="<?php echo $this->content_container; ?> clearfix">
                <?php echo $content; ?>   
            </div>     
        </section>
        <!-- End Content -->
