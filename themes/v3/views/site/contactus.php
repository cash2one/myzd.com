                    ...
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-2">
                            ...
                            <table class="table mb0">
                                ...
                                <tr class="noborder"><td><span class="strong">邮箱：</span></td><td><a class="text-info" href="mailto:service@mingyizhudao.com">service@mingyizhudao.com</a></td></tr>
                                <tr class="noborder"><td><span class="strong">微信：</span></td><td><img class="img-responsive" src="<?php echo Yii::app()->theme->baseUrl; ?>/images/icons/ic_wx.jpg" width="100px"/></td></tr>                                    
                            </table>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <div class="form-group mt30">
                                <div class="col-md-offset-3 col-md-8">
                                    <?php echo CHtml::submitButton('提交', array('class' => 'btn btn-yes btn-lg btn-block')); ?>
                                </div>
                            </div>
...
<div style="display:none;">
    <script type="text/javascript"> var _bdhmProtocol = (("https:" == document.location.protocol) ? " https://" : " http://"); document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3Fd71c117715361c0aac93bf247b5df618' type='text/javascript'%3E%3C/script%3E"))</script>
</div>