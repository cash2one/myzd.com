...
<!-- Content -->
    ...
    <div id="cover">
		...
		<span class="verify pull-right"> 本站已经通过实名认证，所有内容由丁国正医生本人发表</span>
		<div class="avatar">
			<ul class="media-list">
				<li class="media">
					<img class="media-object pull-left" src="<?php echo $urlDP; ?>" alt="">
					<div class="media-body">
						<h3 class="media-heading"><span>丁国正&nbsp;&nbsp;副主任医师&nbsp;&nbsp;</span>
			...
			<div>
				<ul class="list-group">
					...
					<li class="list-group-item">
						...
						<span class="r">15年</span>
					</li>
					<li class="list-group-item">
						<span class="l">擅长：</span>
						<span class="r">支气管哮喘，慢阻肺、呼吸衰竭、肺癌等疾病的诊治。</span>
					</li>
