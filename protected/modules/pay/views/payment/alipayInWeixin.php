...
<html>
    ...
    <body>
        ...
        <script type="text/javascript" src="http://myzd.oss-cn-hangzhou.aliyuncs.com/static%2Fmobile%2Fjs%2Fpingpp-one%2Fpingpp-alipay-in-weixin.js"></script>
        <script>
            if (location.hash.indexOf('error') != -1) {
                ...
                if (ua.indexOf('micromessenger') != -1) {
                    ...
                    location.href = param != '' ? _AP.decode(param) : '#error';
                }
            }
        </script>
    </body>
