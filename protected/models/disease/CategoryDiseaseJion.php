...
/**
 * This is the model class for table "category_disease_jion".
 *
 * The followings are the available columns in table 'category_disease_jion':
 * @property integer $id
 ...
 */
class CategoryDiseaseJion extends CActiveRecord
{
	/**
	 ...
	 * @return CategoryDiseaseJion the static model class
	 */
