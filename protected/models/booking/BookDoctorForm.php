...
class BookDoctorForm extends EFormModel {
    ...
    public function rules() {
        ...
        return array(
            array('bk_status, bk_type, doctor_id, doctor_name', 'required', 'message' => '请填入{attribute}'),
            array('user_id, bk_status, bk_type, doctor_id, hospital_id, hp_dept_id, city_id', 'numerical', 'integerOnly' => true),
...
//            array('mobile', 'length', 'is' => 11),
            ...
            array('id, ref_no, user_id, mobile, contact_name, contact_email, bk_status, bk_type, doctor_id, doctor_name, city_id, hospital_id, hospital_name, hp_dept_id, hp_dept_name, disease_name, disease_detail, date_start, date_end, appt_date, remark, submit_via, date_created,is_commonweal,is_free_clinic', 'safe'),
        );
    }
