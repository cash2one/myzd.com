...
//            $output['error_msg'] = "发送电邮出错";
     ...
     * 创建预约单
     */
    public function creatBooking($values){
        ...
        if (isset($values['tid'])) {
            ...
            return array('viewName'=>'bookExpertteam','form'=>$form);
            ...
            return array('viewName'=>'doctor','form'=>$form);
     ...
     * 快速预约
     */
    public function quickBooking($values){
        $output = array('status' => 'no');
            // 快速预约
